function [ n,m,A,c,b,x,xB,cB,SBA,zjcj,z ] = MDSimplex( n,m,A,c,b,x,xB,cB,SBA,zjcj,z )
%MDSIMPLEX Summary of this function goes here
%   Detailed explanation goes here


termina=0;  % Variable that controls the "while" loop
iteracao=1; % Iterations counter
...
while ~termina   % While termina equals zero
    ...
    if valor_min>=0
        ...
        % Calculate quoccients in absolute value between values of zjcj column and negative values of pivot line
